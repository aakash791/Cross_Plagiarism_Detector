<?php
/*
The html template is downloaded from https://bootstrapious.com/admin-templates
*/
session_start();

$user = $_SESSION['user'];  // store session variable email value
$uid = $_SESSION['uid'];    // store session variable userid value
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            <li class="active"> <a href="dashboard.php"> <i class="fa fa-address-book-o"></i>Show Dashboard</a></li>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      $sql = "SELECT DISTINCT d.dname, d.docid FROM documents d, user u, userdoc ud WHERE ud.docid = d.docid AND ud.uid=? ";
                          ...
                          // data rows
                           ...
                           echo '<tbody>';
                            echo  '<tr>';
                              ...
                              echo  '<td> <a href="viewreport.php?id=' . $row['docid'] .'">View</td>';
                              echo  '<td> <a href="deletereport.php?id='.$row['docid'] .'">Delete</td>';
                            echo '</tr>';
                      ...
                      <h6 align="center" style="color: red;"><?php echo@$_GET["deleted"]; ?></h6>
