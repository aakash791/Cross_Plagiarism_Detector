<?php
/*
This html template is downloaded from https://bootstrapious.com/admin-templates
*/
session_start();

$user = $_SESSION['user'];  // store session variable email value
$docid = $_GET["id"];       // store docid 
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">User Documents Report</h3>
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      //Create sql query 
                      $sql = "SELECT * FROM userdoc ud, userdocresults ur WHERE ud.docid = ur.docid AND ud.docid=?";
                          ...
                          // data rows
                           ...
                           echo '<tbody>';
                            echo  '<tr>';
                              ...
                              echo  '<td><a href="' .$row['link']. '" target=_blank>Click</td>';
                             echo '</tr>';
