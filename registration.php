...
session_start();
/*
The html template is downloaded from https://bootstrapious.com
*/
?>
<!DOCTYPE html>
<html>
                ...
                <div class="content">
                  <form id="register-form" method="POST" action="register.php">
                    <div class="form-group">
                      <input id="register-email" type="email" name="user" placeholder="Email" required class="input-material">
              
                    </div>
                    <div class="form-group">
                      <input id="register-passowrd" type="password" name="pass" placeholder="Password" required class="input-material">
