...
$user = $_SESSION['user'];  // keep track of session variable storing email
$pwd = $_SESSION['pass'];   // keep track of session variable storing password
...
$stmt->bind_result($userid);  // store userid

$stmt->fetch();  // fetch user id from database based on value specified for email and password

$_SESSION['userid'] = $userid;  // keep track of session variable storing userid
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Upload Your File here</h3>
                    </div>
                    <div class="card-body">
                      <form class="form-horizontal" method="POST" action="createprocessfile.php">
                        <div class="form-group row">
                          <div class="col-sm-9">
                           <input style="margin-left: 100px" type="file" name="file" id="file" class="form-control form-control-label">
                          </div>
                        </div>
