...
$docid = $_GET["id"];       // store session value for doc id
...
if($stmt->execute())
{
   header("Location: dashboard.php?deleted=Report Deleted");
}
else
{
   header("Location: dashboard.php?error=Can't Delete Report");
}  
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="welcometext.php" class="navbar-brand">
