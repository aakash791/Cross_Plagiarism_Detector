...
$user = $_SESSION['user'];  // store session value for storing user email
$uid = $_SESSION['uid'];  // store session value for storing user id
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="viewhistory.php"> <i class="fa fa-file"></i>View History</a></li>
          </ul>
        </nav>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      $sql = "SELECT time FROM userhistory WHERE uid = ?";
